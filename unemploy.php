...
<head>
  ...
  $conn=mysql_connect($host,$user,$pass) or die("Can't connect"); // เชื่อมต่อ ฐานข้อมูล
    ...
    $data = mysql_query("SELECT * FROM unemployment") 
  or die(mysql_error()); 
  $rows   = array();
  $temp_1 = array();
  $temp_2 = array();
...
<nav class="navbar navbar-inverse" style="margin-bottom:0px;">
  ...
  <div>
    <ul class="nav navbar-nav">
        ...
        <li class = "active"><a href="unemploy.php">Percent of Unemployment</a></li>
        <li class="dropdown">
        ...
        <div class="row"style="background:#F2F2F2; height:100%";>
         ...
         <h3>Percent of Unemployment</h3><br>
         <p>Unemployment refers to the share of the labor force that is without work but available for and seeking employment.</p>
         </div>
         </div>
