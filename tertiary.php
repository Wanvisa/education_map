...
<head>
  ...
  $conn=mysql_connect($host,$user,$pass) or die("Can't connect"); // เชื่อมต่อ ฐานข้อมูล
    ...
    $data = mysql_query("SELECT * FROM tertiary") 
  or die(mysql_error()); 
  $rows   = array();
  $temp_1 = array();
  $temp_2 = array();
  ...
  <div>
    <ul class="nav navbar-nav">
        ...
        <div class="row"style="background:#F2F2F2; height:100%";>
         ...
         <h3> Percent Gross of Tertiary</h3><br>
        <p>Gross enrolment ratio. Tertiary (ISCED 5 and 6). Total is the total enrollment in tertiary education (ISCED 5 and 6), regardless of age, expressed as a percentage of the total population of the five-year age group following on from secondary school leaving.</p>        
        </div>
         </div>
