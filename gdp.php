...
<head>
  ...
  $conn=mysql_connect($host,$user,$pass) or die("Can't connect"); // เชื่อมต่อ ฐานข้อมูล
    ...
    $data = mysql_query("SELECT * FROM Percent_of_GDP") 
  or die(mysql_error()); 
  $rows   = array();
  $temp_1 = array();
  $temp_2 = array();
  $rows[] = array('Country', '%GDP');
...
<nav class="navbar navbar-inverse" style="margin-bottom:0px;">
  ...
  <div>
    <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="gdp.php">Percent of GDP</a></li>
        ...
        <div class="row"style="background:#F2F2F2; height:100%";>
         ...
         <h3>Percent of GDP</h3><br>
         <p>General government expenditure on education (current, capital, and transfers) is expressed as a percentage of GDP. It includes expenditure funded by transfers from international sources to government. General government usually refers to local, regional and central governments.</p>
         </div>
         </div>
