...
<head>
  ...
  $conn=mysql_connect($host,$user,$pass) or die("Can't connect"); // เชื่อมต่อ ฐานข้อมูล
    ...
    $data = mysql_query("SELECT * FROM preprimary") 
  or die(mysql_error()); 
  $rows   = array();
  $temp_1 = array();
  $temp_2 = array();
  ...
  <div>
    <ul class="nav navbar-nav">
        ...
        <div class="row"style="background:#F2F2F2; height:100%";>
         ...
         <h3> Percent Gross of Pre-primary</h3><br>
         <p>Gross enrolment ratio. Pre-primary. Total is the total enrollment in pre-primary education, regardless of age, expressed as a percentage of the total population of official pre-primary education age. GER can exceed 100% due to the inclusion of over-aged and under-aged students because of early or late school entrance and grade repetition.</p>
         </div>
         </div>
